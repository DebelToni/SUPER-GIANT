...
def init_params(
    ...
    *,
    ...
    dummy_aug = jnp.zeros((batch_size,), dtype=jnp.int32)
    variables = model.init({"params": rng}, dummy_tokens, deterministic=True, aug_ids=dummy_aug)
...
def make_jitted_step(model: TRM):
    ...
    def step(
        ...
        aug_ids: Array,  # (B,) int32 (ignored unless augmentation enabled)
    ):
