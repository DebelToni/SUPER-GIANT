...
@dataclass
class LossConfig:
    """Loss function coefficients for 8-term loss.
    ...
    delta_masked: float = 0.0  # Hard agreement capped up to first AR/Diff argmax mismatch (inclusive)
...
class StageLossConfig:
    ...
    delta_masked: Optional[float] = None
