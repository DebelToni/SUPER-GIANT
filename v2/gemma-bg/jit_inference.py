...
MODEL_CFG = cfg.model
FINAL_LOGIT_SOFTCAP = getattr(MODEL_CFG, "final_logit_softcapping", None)
        ...
        *,
        ...
        def body(carry, i):
            ...
            if FINAL_LOGIT_SOFTCAP is not None:
                cap = jnp.asarray(FINAL_LOGIT_SOFTCAP, dtype=step_logits.dtype)
                step_logits = jnp.tanh(step_logits / cap) * cap
