"""Checkpoint utilities for SUPER-GIANT.

Includes NPZ parameter I/O, checkpoint management, and async mini checkpoints.
"""
...
def _step_from_name(fname: str) -> int:
    match = _CKPT_RE.search(os.path.basename(fname))
